    ...
    <View style={styles.container}>
      ...
      <View style={styles.activeTracking}>
        ...
        <View style={styles.chart}>
          <BarChartSerie text={'protein'} color={'#10C285'} height={'30%'} navigate={toUpdateFood}/>
          <BarChartSerie text={'calories'} color={'#F14570'} height={'50%'} navigate={toUpdateFood}/>
          <BarChartSerie text={'water'} color={'#0099DD'} height={'80%'} navigate={toUpdateWater}/>
        </View>
      </View>
